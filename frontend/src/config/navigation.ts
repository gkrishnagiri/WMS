...
export const navigation: NavigationItem[] = [
  ...
  { label: "Guided Demo Scenarios", path: "/demo-scenarios", experiences: ["full", "operations", "simulation", "agentic"] },
  ...
  { label: "Agent Chat", path: "/agent-chat", experiences: ["full", "agentic"] },
  { label: "User Issue Assistant", path: "/agent-chat/user", experiences: ["full", "business", "agentic"] },
  ...
  { label: "Known Errors", path: "/agent-knowledge/known-errors", experiences: ["full", "operations", "agentic"] },
  { label: "Retrieval Audit", path: "/agent-knowledge/retrieval-queries", experiences: ["full", "operations", "agentic"] },
  ...
  { label: "AI Real Model", path: "/ai-config/real-model", experiences: ["full", "agentic"] },
  { label: "AI Costing", path: "/ai-costing", experiences: ["full", "agentic", "operations"] },
