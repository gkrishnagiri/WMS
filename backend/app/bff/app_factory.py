...
ROUTERS = {
    ...
    "agent_actions": agent_actions_router,
    "agent_model_chat": agent_model_chat_router,
    "batch": batch_router,
    ...
    "baseline_completion": baseline_completion_router,
}
...
def _filtered_exact_router(source: APIRouter, allowed_paths: Iterable[str]) -> APIRouter:
...
def create_bff_app(definition: ExperienceDefinition) -> FastAPI:
    ...
    if definition.code == "business":
        ...
        _include_group(application, "baseline_completion")
